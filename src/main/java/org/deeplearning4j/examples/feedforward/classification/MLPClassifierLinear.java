...
public class MLPClassifierLinear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String filenameTrain  = new ClassPathResource("/classification/mnist_train.csv").getFile().getPath();
        final String filenameTest  = new ClassPathResource("/classification/mnist_test.csv").getFile().getPath();
